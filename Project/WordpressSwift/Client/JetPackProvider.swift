        ...
        if (forType is WPPost.Type) { 
            ...
            if let posts = parseable["posts"].array {
                for post in posts {
                    ...
                    result.featured_media.url = post["featured_image"].string
                    result.thumbnail.url = post["post_thumbnail"]["URL"].string
                    ...
                    for (_, attachmentJson) in post["attachments"] {
                        ...
                        if let attachmentUrl = attachmentJson["URL"].string {
                        ...
                        if let attachmentMedium = attachmentJson["thumbnails"]["medium"].string {
                            attachment.sizes.medium = attachmentMedium
                        }
                        if let attachmentThumbnail = attachmentJson["thumbnails"]["thumbnail"].string {
