...
@objc final class OverviewSwiftController: UICollectionViewController, ConfigParserDelegate{
    ...
    override func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
        ...
        let controller = FrontNavigationController.createViewController(tab, with: self.storyboard)
    ...
    func parseSuccess(_ result: NSMutableArray!) {
        self.items += result as! [Tab]
    ...
    func parseFailed(_ error: Error!) {
