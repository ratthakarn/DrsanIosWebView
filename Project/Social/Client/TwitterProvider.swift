...
class TwitterProvider: SocialProvider {
    ...
    public func get(identifier: String, params: SocialRequestParams, completionHandler: @escaping (Bool, [SocialItem]?, String?) -> Void) {
        ...
        let swifter = Swifter(consumerKey: AppDelegate.twitterAPI(), consumerSecret: AppDelegate.twitterAPISecret(), oauthToken: AppDelegate.twitterToken(), oauthTokenSecret: AppDelegate.twitterTokenSecret())
