...
class MapsViewController: UIViewController, GMSMapViewDelegate {
                ...
                (session.dataTask(with: url, completionHandler: { data, response, error in
                    DispatchQueue.main.async(execute: {
                        ...
                        if error != nil {
                            ...
                            let alertController = UIAlertController(title: NSLocalizedString("error", comment: ""), message: NO_CONNECTION_TEXT, preferredStyle: .alert)
    ...
    func mapView(_ mapView: GMSMapView, didTapInfoWindowOf marker: GMSMarker) {
        if (marker.userData! as! [String: String])["url"] != nil {
            AppDelegate.openUrl((marker.userData! as! [String: String])["url"], with: navigationController)
        }
    }
    ...
    @objc func openUrl() {
        AppDelegate.openUrl((mapView_.selectedMarker!.userData as! [String: String])["url"], with: navigationController)
    }
